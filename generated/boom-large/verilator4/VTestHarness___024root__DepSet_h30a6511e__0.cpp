...
void VTestHarness___024root__nba_mtask62(VTestHarness___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestHarness___024root__nba_mtask62\n"); );
    VTestHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void VTestHarness___024root__nba_mtask63(VTestHarness___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestHarness___024root__nba_mtask63\n"); );
    VTestHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    static constexpr unsigned taskId = 63;
    Verilated::mtaskId(taskId);
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
...
void VTestHarness___024root__nba_mtask64(VTestHarness___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestHarness___024root__nba_mtask64\n"); );
    VTestHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    static constexpr unsigned taskId = 64;
    Verilated::mtaskId(taskId);
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
...
void VTestHarness___024root__nba_mtask65(VTestHarness___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestHarness___024root__nba_mtask65\n"); );
    VTestHarness__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
void VTestHarness___024root____Vthread__nba__t1__s0(void* voidSelf, bool even_cycle) {
    ...
    VTestHarness___024root__nba_mtask64(vlSelf);
    vlSelf->__Vm_mtaskstate_62.waitUntilUpstreamDone(even_cycle);
    VTestHarness___024root__nba_mtask62(vlSelf);
    vlSelf->__Vm_mtaskstate_final__0nba.signalUpstreamDone(even_cycle);
}
...
void VTestHarness___024root____Vthread__nba__t2__s0(void* voidSelf, bool even_cycle) {
    ...
    VTestHarness___024root__nba_mtask65(vlSelf);
    vlSelf->__Vm_mtaskstate_63.waitUntilUpstreamDone(even_cycle);
    VTestHarness___024root__nba_mtask63(vlSelf);
    vlSelf->__Vm_mtaskstate_final__0nba.signalUpstreamDone(even_cycle);
}
